...
namespace UI
{
    public class DialogUI : ToolkitCanvasUI
    {
        ...
        // Not used for now, but would be useful if I had images
        ...
        protected override void Init()
        {
            ...
            root.Q<VisualElement>("Container").RegisterCallback<ClickEvent>(ClickToSkip);
        
            ClearChoices();
            Hide();
        }

        private void ClickToSkip(ClickEvent ce)
        {
            TryToSkip?.Invoke();
        }
        ...
        public void DisplayDialog(string dialogText, string speakerName, bool onLeftSide = true, float timeBetweenLetters = 0.1f, bool instant = false)
        {
